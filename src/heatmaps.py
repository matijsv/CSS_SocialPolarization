...
def plot_heatmap(file_path, image_title, parameter, reverse_columns = True):
    ...
    Args:
        ...
        parameter (str) : What is the parameter varied in the matrix. This is also a title for the legend on the right-hand side of the heatmap. 
        reverse_columns (bool) : If True the order of columns are reversed to make the plot look like the the plot in the paper. 
    """
    ...
    fig = sns.heatmap(reversed_data, annot=False, cmap='magma', cbar_kws={'label': parameter})
