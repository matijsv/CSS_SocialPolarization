...
M_GENERATOR = 2 # Parameter for the barabasi albert graph generator DEFAULT = 2,
                # resulting in a degree distibrution power law between 2 and 3, as per the paper
